...
class Kaal {
    ...
    constructor(repoPath = '.') {
        this.repoPath = path.join(repoPath, '.kaal');
        this.objectsPath = path.join(this.repoPath, 'objects'); // .kaal/objects
        this.headPath = path.join(this.repoPath, 'HEAD'); // .kaal/HEAD
        this.indexPath = path.join(this.repoPath, 'index'); // .kaal/index
        this.init();
    }
    ...
    async init() {
        ...
        try {
            ...
            console.log("Already initialised the .kaal folder");
        }
    }
    ...
    async add(fileToBeAdded) {
        ...
        const newFileHashedObjectPath = path.join(this.objectsPath, fileHash); // .kaal/objects/abc123
...
// (async () => {
//     const kaal = new kaal();
//     // await kaal.add('sample.txt');
//     // await kaal.add('sample2.txt');
//     // await kaal.commit('4th commit');

//     // await kaal.log();
//     await kaal.showCommitDiff('7b9d7266145f34073d310f02d42568c6c3213bb4');
// })();
...
program.command('show <commitHash>').action(async (commitHash) => {
    const kaal = new Kaal();
    await kaal.showCommitDiff(commitHash);
});
